        ...
        <section className="grid justify-items-center items-center h-screen w-screen bg-gray-100">
            ...
            <div className="container-element max-w-2xl p-4">
                ...
                <div className="text-center">
                    ...
                    <h2 className="text-4xl font-bold mb-4">Inscrivez-vous!</h2>
                </div>
                {/* */}
                <form onSubmit={sendFormValue} className="shadow p-5 rounded-lg my-4 bg-white">
                     {/* */}
                    <label className="text-base font-semibold" for="lastname">Nom:</label><br/>
                    <input id="lastname" type="text" required  minLength="3" value={lastname} onChange={handleLastName} maxLength="75" className=" h-10 mt-2 mb-6 w-full border border-gray-300 p-2 rounded-lg shadow focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-transparent"></input>
                    {/* */}
                    <label className="text-base font-semibold" for="firstname">Prénom:</label><br/>
                    <input id="firstname" type="text" required  minLength="3" value={firstname} onChange={handleFirstName} maxLength="75" className=" h-10 mt-2 mb-6 w-full border border-gray-300 p-2 rounded-lg shadow focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-transparent"></input>
                    {/* */}
                    ...
                    {/* */}
                    <Link to="/connexion" className="underline text-base cursor-pointer text-indigo-500">Vous avez déjà un compte? Connectez-vous !</Link>
              </form>
            </div>
    ...
    return (
        ...
        <div id="popup" className="w-60 h-52 rounded-lg  bg-white shadow">
            <div className="w-full h-full relative grid justify-items-center p-2">
                <p className="text-center relative top-5 font-satisfy text-3xl mb-4">Vous êtes maintenant inscris sur Unphotos</p>
...
function ErrorPopup({hide}) {
    return (
        ...
        <div id="popup" className="w-60 h-48 rounded-lg  bg-white shadow ring-2 ring-red-400">
            <div className="w-full h-full relative grid justify-items-center p-2">
                <p className="text-center relative top-5 font-satisfy text-3xl mb-4">Cet email a déjà été utilisé...</p>
